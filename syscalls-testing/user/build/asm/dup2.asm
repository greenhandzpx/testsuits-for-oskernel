...
/home/zpx/code/testsuits-for-oskernel/riscv-syscalls-testing/user/build/loongarch64/dup2:     file format elf64-loongarch
...
void test_dup2(){
    ...
    1034:	02819005 	addi.w	$r5,$r0,100(0x64)
    1038:	02800404 	addi.w	$r4,$r0,1(0x1)
    103c:	5414c400 	bl	5316(0x14c4) # 2500 <dup2>
	assert(fd != -1);
    1040:	02bffc0c 	addi.w	$r12,$r0,-1(0xfff)
    1044:	5800508c 	beq	$r4,$r12,80(0x50) # 1094 <test_dup2+0x8c>
	const char *str = "  from fd 100\n";
	write(100, str, strlen(str));
    1048:	1c000024 	pcaddu12i	$r4,1(0x1)
    104c:	02d5e084 	addi.d	$r4,$r4,1400(0x578)
    1050:	540a5c00 	bl	2652(0xa5c) # 1aac <strlen>
    1054:	00150086 	move	$r6,$r4
    1058:	1c000025 	pcaddu12i	$r5,1(0x1)
    105c:	02d5a0a5 	addi.d	$r5,$r5,1384(0x568)
    1060:	02819004 	addi.w	$r4,$r0,100(0x64)
    1064:	54119c00 	bl	4508(0x119c) # 2200 <write>
	TEST_END(__func__);
    1068:	1c000024 	pcaddu12i	$r4,1(0x1)
    106c:	02d5a084 	addi.d	$r4,$r4,1384(0x568)
    1070:	54035800 	bl	856(0x358) # 13c8 <puts>
    1074:	1c000024 	pcaddu12i	$r4,1(0x1)
    1078:	02d5d084 	addi.d	$r4,$r4,1396(0x574)
    ...
    10a0:	53ffabff 	b	-88(0xfffffa8) # 1048 <test_dup2+0x40>
...
int main(void) {
	...
	test_dup2();
    10ac:	57ff5fff 	bl	-164(0xfffff5c) # 1008 <test_dup2>
	return 0;
}
    ...
    10f0:	29c0a061 	st.d	$r1,$r3,40(0x28)
{
    ...
    1100:	02d3f18c 	addi.d	$r12,$r12,1276(0x4fc)
    ...
    12c8:	02ccd18c 	addi.d	$r12,$r12,820(0x334)
    ...
    140c:	140000fa 	lu12i.w	$r26,7(0x7)
{
    ...
    1458:	02c6939c 	addi.d	$r28,$r28,420(0x1a4)
        if (!*s)
    ...
    1708:	02fb72f7 	addi.d	$r23,$r23,-292(0xedc)
