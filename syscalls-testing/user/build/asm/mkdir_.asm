...
/home/zpx/code/testsuits-for-oskernel/riscv-syscalls-testing/user/build/loongarch64/mkdir_:     file format elf64-loongarch
...
void test_mkdir(void){
    ...
    TEST_START(__func__);
    101c:	5403e800 	bl	1000(0x3e8) # 1404 <puts>
    1020:	1c000024 	pcaddu12i	$r4,1(0x1)
    1024:	02d90084 	addi.d	$r4,$r4,1600(0x640)
    1028:	5403dc00 	bl	988(0x3dc) # 1404 <puts>
    102c:	1c000024 	pcaddu12i	$r4,1(0x1)
    1030:	02d69084 	addi.d	$r4,$r4,1444(0x5a4)
    1034:	5403d000 	bl	976(0x3d0) # 1404 <puts>
    int rt, fd;
    ...
    1044:	5414a400 	bl	5284(0x14a4) # 24e8 <mkdir>
    printf("mkdir ret: %d\n", rt);
    1048:	00150085 	move	$r5,$r4
    rt = mkdir("test_mkdir", 0666);
    104c:	00150097 	move	$r23,$r4
    printf("mkdir ret: %d\n", rt);
    1050:	1c000024 	pcaddu12i	$r4,1(0x1)
    1054:	02d68084 	addi.d	$r4,$r4,1440(0x5a0)
    1058:	5403e400 	bl	996(0x3e4) # 143c <printf>
    assert(rt != -1);
    105c:	02bffc0c 	addi.w	$r12,$r0,-1(0xfff)
    1060:	580072ec 	beq	$r23,$r12,112(0x70) # 10d0 <test_mkdir+0xc8>
    fd = open("test_mkdir", O_RDONLY | O_DIRECTORY);
    1064:	14004005 	lu12i.w	$r5,512(0x200)
    1068:	1c000024 	pcaddu12i	$r4,1(0x1)
    106c:	02d5e084 	addi.d	$r4,$r4,1400(0x578)
    1070:	54117800 	bl	4472(0x1178) # 21e8 <open>
    1074:	00150097 	move	$r23,$r4
    if(fd > 0){
    1078:	64004804 	bge	$r0,$r4,72(0x48) # 10c0 <test_mkdir+0xb8>
        printf("  mkdir success.\n");
    107c:	1c000024 	pcaddu12i	$r4,1(0x1)
    1080:	02d69084 	addi.d	$r4,$r4,1444(0x5a4)
    1084:	5403b800 	bl	952(0x3b8) # 143c <printf>
        close(fd);
    1088:	001502e4 	move	$r4,$r23
    108c:	54119400 	bl	4500(0x1194) # 2220 <close>
    }
    else printf("  mkdir error.\n");
    TEST_END(__func__);
    1090:	1c000024 	pcaddu12i	$r4,1(0x1)
    1094:	02d6e084 	addi.d	$r4,$r4,1464(0x5b8)
    1098:	54036c00 	bl	876(0x36c) # 1404 <puts>
    109c:	1c000024 	pcaddu12i	$r4,1(0x1)
    10a0:	02d71084 	addi.d	$r4,$r4,1476(0x5c4)
    10a4:	54036000 	bl	864(0x360) # 1404 <puts>
}
    10a8:	28c02061 	ld.d	$r1,$r3,8(0x8)
    10ac:	26000077 	ldptr.d	$r23,$r3,0
    TEST_END(__func__);
    10b0:	1c000024 	pcaddu12i	$r4,1(0x1)
    10b4:	02d48084 	addi.d	$r4,$r4,1312(0x520)
}
    10b8:	02c04063 	addi.d	$r3,$r3,16(0x10)
    TEST_END(__func__);
    10bc:	50034800 	b	840(0x348) # 1404 <puts>
    else printf("  mkdir error.\n");
    10c0:	1c000024 	pcaddu12i	$r4,1(0x1)
    10c4:	02d5e084 	addi.d	$r4,$r4,1400(0x578)
    10c8:	54037400 	bl	884(0x374) # 143c <printf>
    10cc:	53ffc7ff 	b	-60(0xfffffc4) # 1090 <test_mkdir+0x88>
    assert(rt != -1);
    10d0:	1c000024 	pcaddu12i	$r4,1(0x1)
    10d4:	02d4c084 	addi.d	$r4,$r4,1328(0x530)
    10d8:	54067400 	bl	1652(0x674) # 174c <panic>
    10dc:	53ff8bff 	b	-120(0xfffff88) # 1064 <test_mkdir+0x5c>
...
int main(void){
    ...
    test_mkdir();
    10e8:	57ff23ff 	bl	-224(0xfffff20) # 1008 <test_mkdir>
    return 0;
}
    ...
    112c:	29c0a061 	st.d	$r1,$r3,40(0x28)
{
    ...
    113c:	02d4e18c 	addi.d	$r12,$r12,1336(0x538)
    ...
    1304:	02cdc18c 	addi.d	$r12,$r12,880(0x370)
    ...
    1448:	140000fa 	lu12i.w	$r26,7(0x7)
{
    ...
    1494:	02c7839c 	addi.d	$r28,$r28,480(0x1e0)
        if (!*s)
    ...
    1744:	02fc62f7 	addi.d	$r23,$r23,-232(0xf18)
