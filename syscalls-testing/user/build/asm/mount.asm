...
/home/zpx/code/testsuits-for-oskernel/riscv-syscalls-testing/user/build/loongarch64/mount:     file format elf64-loongarch
...
void test_mount() {
	...
	TEST_START(__func__);
    101c:	54044c00 	bl	1100(0x44c) # 1468 <puts>
    1020:	1c000024 	pcaddu12i	$r4,1(0x1)
    1024:	02dd0084 	addi.d	$r4,$r4,1856(0x740)
    1028:	54044000 	bl	1088(0x440) # 1468 <puts>
    102c:	1c000024 	pcaddu12i	$r4,1(0x1)
    1030:	02d81084 	addi.d	$r4,$r4,1540(0x604)
    1034:	54043400 	bl	1076(0x434) # 1468 <puts>

	printf("Mounting dev:%s to %s\n", device, mntpoint);
    1038:	1c000026 	pcaddu12i	$r6,1(0x1)
    103c:	02dba0c6 	addi.d	$r6,$r6,1768(0x6e8)
    1040:	1c000025 	pcaddu12i	$r5,1(0x1)
    1044:	02da80a5 	addi.d	$r5,$r5,1696(0x6a0)
    1048:	1c000024 	pcaddu12i	$r4,1(0x1)
    104c:	02d7e084 	addi.d	$r4,$r4,1528(0x5f8)
    1050:	54045000 	bl	1104(0x450) # 14a0 <printf>
	int ret = mount(device, mntpoint, fs_type, 0, NULL);
    1054:	1c000025 	pcaddu12i	$r5,1(0x1)
    1058:	02db30a5 	addi.d	$r5,$r5,1740(0x6cc)
    105c:	00150008 	move	$r8,$r0
    1060:	00150007 	move	$r7,$r0
    1064:	1c000026 	pcaddu12i	$r6,1(0x1)
    1068:	02d7d0c6 	addi.d	$r6,$r6,1524(0x5f4)
    106c:	1c000024 	pcaddu12i	$r4,1(0x1)
    1070:	02d9d084 	addi.d	$r4,$r4,1652(0x674)
    1074:	54154000 	bl	5440(0x1540) # 25b4 <mount>
    1078:	00150097 	move	$r23,$r4
	printf("mount return: %d\n", ret);
    107c:	00150085 	move	$r5,$r4
    1080:	1c000024 	pcaddu12i	$r4,1(0x1)
    1084:	02d78084 	addi.d	$r4,$r4,1504(0x5e0)
    1088:	54041800 	bl	1048(0x418) # 14a0 <printf>
	assert(ret == 0);
    108c:	44005ee0 	bnez	$r23,92(0x5c) # 10e8 <test_mount+0xe0>

	if (ret == 0) {
		printf("mount successfully\n");
    1090:	1c000024 	pcaddu12i	$r4,1(0x1)
    1094:	02d86084 	addi.d	$r4,$r4,1560(0x618)
    1098:	54040800 	bl	1032(0x408) # 14a0 <printf>
		ret = umount(mntpoint);
    109c:	1c000024 	pcaddu12i	$r4,1(0x1)
    10a0:	02da1084 	addi.d	$r4,$r4,1668(0x684)
    10a4:	54152000 	bl	5408(0x1520) # 25c4 <umount>
		printf("umount return: %d\n", ret);
    10a8:	00150085 	move	$r5,$r4
    10ac:	1c000024 	pcaddu12i	$r4,1(0x1)
    10b0:	02d85084 	addi.d	$r4,$r4,1556(0x614)
    10b4:	5403ec00 	bl	1004(0x3ec) # 14a0 <printf>
	}

	TEST_END(__func__);
    10b8:	1c000024 	pcaddu12i	$r4,1(0x1)
    10bc:	02d78084 	addi.d	$r4,$r4,1504(0x5e0)
    10c0:	5403a800 	bl	936(0x3a8) # 1468 <puts>
    10c4:	1c000024 	pcaddu12i	$r4,1(0x1)
    10c8:	02da7084 	addi.d	$r4,$r4,1692(0x69c)
    10cc:	54039c00 	bl	924(0x39c) # 1468 <puts>
}
    10d0:	28c02061 	ld.d	$r1,$r3,8(0x8)
    10d4:	26000077 	ldptr.d	$r23,$r3,0
	TEST_END(__func__);
    10d8:	1c000024 	pcaddu12i	$r4,1(0x1)
    10dc:	02d56084 	addi.d	$r4,$r4,1368(0x558)
}
    10e0:	02c04063 	addi.d	$r3,$r3,16(0x10)
	TEST_END(__func__);
    10e4:	50038400 	b	900(0x384) # 1468 <puts>
	assert(ret == 0);
    10e8:	1c000024 	pcaddu12i	$r4,1(0x1)
    10ec:	02d64084 	addi.d	$r4,$r4,1424(0x590)
    10f0:	5406c000 	bl	1728(0x6c0) # 17b0 <panic>
	if (ret == 0) {
    10f4:	53ffc7ff 	b	-60(0xfffffc4) # 10b8 <test_mount+0xb0>

00000000000010f8 <main>:

int main(int argc,char *argv[]) {
    10f8:	02ff8063 	addi.d	$r3,$r3,-32(0xfe0)
    10fc:	29c06061 	st.d	$r1,$r3,24(0x18)
    1100:	29c04077 	st.d	$r23,$r3,16(0x10)
    1104:	29c02078 	st.d	$r24,$r3,8(0x8)
	if(argc >= 2){
    1108:	0280040c 	addi.w	$r12,$r0,1(0x1)
    110c:	60002184 	blt	$r12,$r4,32(0x20) # 112c <main+0x34>
	...
	test_mount();
    1110:	57fefbff 	bl	-264(0xffffef8) # 1008 <test_mount>
	return 0;
}
    1114:	28c06061 	ld.d	$r1,$r3,24(0x18)
    1118:	28c04077 	ld.d	$r23,$r3,16(0x10)
    111c:	28c02078 	ld.d	$r24,$r3,8(0x8)
    1120:	00150004 	move	$r4,$r0
    1124:	02c08063 	addi.d	$r3,$r3,32(0x20)
    1128:	4c000020 	jirl	$r0,$r1,0
		strcpy(device, argv[1]);
    112c:	001500b8 	move	$r24,$r5
    1130:	28c020a5 	ld.d	$r5,$r5,8(0x8)
    1134:	00150097 	move	$r23,$r4
    1138:	1c000024 	pcaddu12i	$r4,1(0x1)
    113c:	02d6a084 	addi.d	$r4,$r4,1448(0x5a8)
    1140:	540d2400 	bl	3364(0xd24) # 1e64 <strcpy>
	if(argc >= 3){
    1144:	0280080c 	addi.w	$r12,$r0,2(0x2)
    1148:	5bffcaec 	beq	$r23,$r12,-56(0x3ffc8) # 1110 <main+0x18>
		strcpy(mntpoint, argv[2]);
    114c:	28c04305 	ld.d	$r5,$r24,16(0x10)
    1150:	1c000024 	pcaddu12i	$r4,1(0x1)
    1154:	02d74084 	addi.d	$r4,$r4,1488(0x5d0)
    1158:	540d0c00 	bl	3340(0xd0c) # 1e64 <strcpy>
    115c:	53ffb7ff 	b	-76(0xfffffb4) # 1110 <main+0x18>
    ...
    116c:	02c020a5 	addi.d	$r5,$r5,8(0x8)
{
	...
	exit(main(argc, argv));
    1174:	57ff87ff 	bl	-124(0xfffff84) # 10f8 <main>
    ...
    1190:	29c0a061 	st.d	$r1,$r3,40(0x28)
{
    ...
    11a0:	02d7518c 	addi.d	$r12,$r12,1492(0x5d4)
    ...
    1368:	02d0318c 	addi.d	$r12,$r12,1036(0x40c)
    ...
    14ac:	140000fa 	lu12i.w	$r26,7(0x7)
{
    ...
    14f8:	02c9f39c 	addi.d	$r28,$r28,636(0x27c)
        if (!*s)
    ...
    17a8:	02fcd2f7 	addi.d	$r23,$r23,-204(0xf34)
