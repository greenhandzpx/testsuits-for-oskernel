...
/home/zpx/code/testsuits-for-oskernel/riscv-syscalls-testing/user/build/loongarch64/mmap:     file format elf64-loongarch
...
_start:
    ...
    bl __start_main
    1004:	54014800 	bl	328(0x148) # 114c <__start_main>

0000000000001008 <test_mmap>:
 * "  Hello, mmap success"
 * 测试失败时输出：
 * "mmap error."
 */
...
void test_mmap(void){
    ...
    1020:	27000079 	stptr.d	$r25,$r3,0
    TEST_START(__func__);
    1024:	54043000 	bl	1072(0x430) # 1454 <puts>
    1028:	1c000024 	pcaddu12i	$r4,1(0x1)
    102c:	02dba084 	addi.d	$r4,$r4,1768(0x6e8)
    1030:	54042400 	bl	1060(0x424) # 1454 <puts>
    1034:	1c000024 	pcaddu12i	$r4,1(0x1)
    1038:	02d73084 	addi.d	$r4,$r4,1484(0x5cc)
    103c:	54041800 	bl	1048(0x418) # 1454 <puts>
    char *array;
    const char *str = "  Hello, mmap successfully!";
    int fd;

    fd = open("test_mmap.txt", O_RDWR | O_CREATE);
    1040:	02810805 	addi.w	$r5,$r0,66(0x42)
    1044:	1c000024 	pcaddu12i	$r4,1(0x1)
    1048:	02d73084 	addi.d	$r4,$r4,1484(0x5cc)
    104c:	5411d000 	bl	4560(0x11d0) # 221c <open>
    1050:	00150097 	move	$r23,$r4
    write(fd, str, strlen(str));
    1054:	1c000024 	pcaddu12i	$r4,1(0x1)
    1058:	02d73084 	addi.d	$r4,$r4,1484(0x5cc)
    105c:	540ac000 	bl	2752(0xac0) # 1b1c <strlen>
    1060:	00150086 	move	$r6,$r4
    1064:	1c000025 	pcaddu12i	$r5,1(0x1)
    1068:	02d6f0a5 	addi.d	$r5,$r5,1468(0x5bc)
    106c:	001502e4 	move	$r4,$r23
    1070:	54120000 	bl	4608(0x1200) # 2270 <write>
    fstat(fd, &kst);
    1074:	1c000025 	pcaddu12i	$r5,1(0x1)
    1078:	02d870a5 	addi.d	$r5,$r5,1564(0x61c)
    107c:	001502e4 	move	$r4,$r23
    1080:	5413e400 	bl	5092(0x13e4) # 2464 <fstat>
    printf("file len: %d\n", kst.st_size);
    1084:	1c000038 	pcaddu12i	$r24,1(0x1)
    1088:	02d83318 	addi.d	$r24,$r24,1548(0x60c)
    108c:	28c0c305 	ld.d	$r5,$r24,48(0x30)
    1090:	1c000024 	pcaddu12i	$r4,1(0x1)
    1094:	02d6c084 	addi.d	$r4,$r4,1456(0x5b0)
    1098:	5403f400 	bl	1012(0x3f4) # 148c <printf>
    array = mmap(NULL, kst.st_size, PROT_WRITE | PROT_READ, MAP_FILE | MAP_SHARED, fd, 0);
    109c:	28c0c305 	ld.d	$r5,$r24,48(0x30)
    10a0:	00150009 	move	$r9,$r0
    10a4:	001502e8 	move	$r8,$r23
    10a8:	02800407 	addi.w	$r7,$r0,1(0x1)
    10ac:	02800c06 	addi.w	$r6,$r0,3(0x3)
    10b0:	00150004 	move	$r4,$r0
    10b4:	54134400 	bl	4932(0x1344) # 23f8 <mmap>
    //printf("return array: %x\n", array);

    if (array == MAP_FAILED) {
    10b8:	02bffc0c 	addi.w	$r12,$r0,-1(0xfff)
    10bc:	5800648c 	beq	$r4,$r12,100(0x64) # 1120 <test_mmap+0x118>
	printf("mmap error.\n");
    }else{
	printf("mmap content: %s\n", array);
    10c0:	00150085 	move	$r5,$r4
    10c4:	00150099 	move	$r25,$r4
    10c8:	1c000024 	pcaddu12i	$r4,1(0x1)
    10cc:	02d66084 	addi.d	$r4,$r4,1432(0x598)
    10d0:	5403bc00 	bl	956(0x3bc) # 148c <printf>
	//printf("%s\n", str);

	munmap(array, kst.st_size);
    10d4:	28c0c305 	ld.d	$r5,$r24,48(0x30)
    10d8:	00150324 	move	$r4,$r25
    10dc:	54132800 	bl	4904(0x1328) # 2404 <munmap>
    }

    close(fd);
    10e0:	001502e4 	move	$r4,$r23
    10e4:	54117000 	bl	4464(0x1170) # 2254 <close>

    TEST_END(__func__);
    10e8:	1c000024 	pcaddu12i	$r4,1(0x1)
    10ec:	02d64084 	addi.d	$r4,$r4,1424(0x590)
    10f0:	54036400 	bl	868(0x364) # 1454 <puts>
    10f4:	1c000024 	pcaddu12i	$r4,1(0x1)
    10f8:	02d87084 	addi.d	$r4,$r4,1564(0x61c)
    10fc:	54035800 	bl	856(0x358) # 1454 <puts>
}
    1100:	28c06061 	ld.d	$r1,$r3,24(0x18)
    1104:	28c04077 	ld.d	$r23,$r3,16(0x10)
    1108:	28c02078 	ld.d	$r24,$r3,8(0x8)
    110c:	26000079 	ldptr.d	$r25,$r3,0
    TEST_END(__func__);
    1110:	1c000024 	pcaddu12i	$r4,1(0x1)
    1114:	02d3c084 	addi.d	$r4,$r4,1264(0x4f0)
}
    1118:	02c08063 	addi.d	$r3,$r3,32(0x20)
    TEST_END(__func__);
    111c:	50033800 	b	824(0x338) # 1454 <puts>
	printf("mmap error.\n");
    1120:	1c000024 	pcaddu12i	$r4,1(0x1)
    1124:	02d4c084 	addi.d	$r4,$r4,1328(0x530)
    1128:	54036400 	bl	868(0x364) # 148c <printf>
    112c:	53ffb7ff 	b	-76(0xfffffb4) # 10e0 <test_mmap+0xd8>

0000000000001130 <main>:

int main(void){
    1130:	02ffc063 	addi.d	$r3,$r3,-16(0xff0)
    1134:	29c02061 	st.d	$r1,$r3,8(0x8)
    test_mmap();
    1138:	57fed3ff 	bl	-304(0xffffed0) # 1008 <test_mmap>
    return 0;
}
    113c:	28c02061 	ld.d	$r1,$r3,8(0x8)
    1140:	00150004 	move	$r4,$r0
    1144:	02c04063 	addi.d	$r3,$r3,16(0x10)
    1148:	4c000020 	jirl	$r0,$r1,0
...
{
    114c:	00150085 	move	$r5,$r4
	int argc = p[0];
	char **argv = (void *)(p+1);

	exit(main(argc, argv));
    1150:	24000084 	ldptr.w	$r4,$r4,0
{
    1154:	02ffc063 	addi.d	$r3,$r3,-16(0xff0)
	exit(main(argc, argv));
    1158:	02c020a5 	addi.d	$r5,$r5,8(0x8)
{
    115c:	29c02061 	st.d	$r1,$r3,8(0x8)
	exit(main(argc, argv));
    1160:	57ffd3ff 	bl	-48(0xfffffd0) # 1130 <main>
    1164:	54118000 	bl	4480(0x1180) # 22e4 <exit>
	return 0;
}
    1168:	28c02061 	ld.d	$r1,$r3,8(0x8)
    116c:	00150004 	move	$r4,$r0
    1170:	02c04063 	addi.d	$r3,$r3,16(0x10)
    1174:	4c000020 	jirl	$r0,$r1,0
...
static void printint(int xx, int base, int sign)
    1178:	02ff4063 	addi.d	$r3,$r3,-48(0xfd0)
    117c:	29c0a061 	st.d	$r1,$r3,40(0x28)
{
    char buf[16 + 1];
    int i;
    uint x;
    ...
    if (sign && (sign = xx < 0))
    1180:	6001cc80 	blt	$r4,$r0,460(0x1cc) # 134c <printint.constprop.0+0x1d4>
        x = -xx;
    else
        x = xx;
    1184:	0015008e 	move	$r14,$r4
    ...
    {
        buf[i--] = digits[x % base];
    1188:	1c00002c 	pcaddu12i	$r12,1(0x1)
    118c:	02d6618c 	addi.d	$r12,$r12,1432(0x598)
    1190:	002195cf 	mod.wu	$r15,$r14,$r5
    1194:	5c0008a0 	bne	$r5,$r0,8(0x8) # 119c <printint.constprop.0+0x24>
    1198:	002a0007 	break	0x7
    } while ((x /= base) != 0);
    119c:	002115cd 	div.wu	$r13,$r14,$r5
    11a0:	5c0008a0 	bne	$r5,$r0,8(0x8) # 11a8 <printint.constprop.0+0x30>
    11a4:	002a0007 	break	0x7
        buf[i--] = digits[x % base];
    11a8:	00df01ef 	bstrpick.d	$r15,$r15,0x1f,0x0
    11ac:	38203d8f 	ldx.bu	$r15,$r12,$r15
    buf[16] = 0;
    11b0:	29006060 	st.b	$r0,$r3,24(0x18)
        buf[i--] = digits[x % base];
    11b4:	29005c6f 	st.b	$r15,$r3,23(0x17)
    } while ((x /= base) != 0);
    11b8:	680219c5 	bltu	$r14,$r5,536(0x218) # 13d0 <printint.constprop.0+0x258>
        buf[i--] = digits[x % base];
    11bc:	002195af 	mod.wu	$r15,$r13,$r5
    11c0:	5c0008a0 	bne	$r5,$r0,8(0x8) # 11c8 <printint.constprop.0+0x50>
    11c4:	002a0007 	break	0x7
    11c8:	00df01ef 	bstrpick.d	$r15,$r15,0x1f,0x0
    } while ((x /= base) != 0);
    11cc:	002115ae 	div.wu	$r14,$r13,$r5
    11d0:	5c0008a0 	bne	$r5,$r0,8(0x8) # 11d8 <printint.constprop.0+0x60>
    11d4:	002a0007 	break	0x7
        buf[i--] = digits[x % base];
    11d8:	38203d8f 	ldx.bu	$r15,$r12,$r15
    11dc:	2900586f 	st.b	$r15,$r3,22(0x16)
    } while ((x /= base) != 0);
    11e0:	6801c1a5 	bltu	$r13,$r5,448(0x1c0) # 13a0 <printint.constprop.0+0x228>
        buf[i--] = digits[x % base];
    11e4:	002195cf 	mod.wu	$r15,$r14,$r5
    11e8:	5c0008a0 	bne	$r5,$r0,8(0x8) # 11f0 <printint.constprop.0+0x78>
    11ec:	002a0007 	break	0x7
    11f0:	00df01ef 	bstrpick.d	$r15,$r15,0x1f,0x0
    } while ((x /= base) != 0);
    11f4:	002115cd 	div.wu	$r13,$r14,$r5
    11f8:	5c0008a0 	bne	$r5,$r0,8(0x8) # 1200 <printint.constprop.0+0x88>
    11fc:	002a0007 	break	0x7
        buf[i--] = digits[x % base];
    1200:	38203d8f 	ldx.bu	$r15,$r12,$r15
    1204:	2900546f 	st.b	$r15,$r3,21(0x15)
    } while ((x /= base) != 0);
    1208:	6801a5c5 	bltu	$r14,$r5,420(0x1a4) # 13ac <printint.constprop.0+0x234>
        buf[i--] = digits[x % base];
    120c:	002195af 	mod.wu	$r15,$r13,$r5
    1210:	5c0008a0 	bne	$r5,$r0,8(0x8) # 1218 <printint.constprop.0+0xa0>
    1214:	002a0007 	break	0x7
    1218:	00df01ef 	bstrpick.d	$r15,$r15,0x1f,0x0
    } while ((x /= base) != 0);
    121c:	002115ae 	div.wu	$r14,$r13,$r5
    1220:	5c0008a0 	bne	$r5,$r0,8(0x8) # 1228 <printint.constprop.0+0xb0>
    1224:	002a0007 	break	0x7
        buf[i--] = digits[x % base];
    1228:	38203d8f 	ldx.bu	$r15,$r12,$r15
    122c:	2900506f 	st.b	$r15,$r3,20(0x14)
    } while ((x /= base) != 0);
    1230:	680189a5 	bltu	$r13,$r5,392(0x188) # 13b8 <printint.constprop.0+0x240>
        buf[i--] = digits[x % base];
    1234:	002195cf 	mod.wu	$r15,$r14,$r5
    1238:	5c0008a0 	bne	$r5,$r0,8(0x8) # 1240 <printint.constprop.0+0xc8>
    123c:	002a0007 	break	0x7
    1240:	00df01ef 	bstrpick.d	$r15,$r15,0x1f,0x0
    } while ((x /= base) != 0);
    1244:	002115cd 	div.wu	$r13,$r14,$r5
    1248:	5c0008a0 	bne	$r5,$r0,8(0x8) # 1250 <printint.constprop.0+0xd8>
    124c:	002a0007 	break	0x7
        buf[i--] = digits[x % base];
    1250:	38203d8f 	ldx.bu	$r15,$r12,$r15
    1254:	29004c6f 	st.b	$r15,$r3,19(0x13)
    } while ((x /= base) != 0);
    1258:	68016dc5 	bltu	$r14,$r5,364(0x16c) # 13c4 <printint.constprop.0+0x24c>
        buf[i--] = digits[x % base];
    125c:	002195af 	mod.wu	$r15,$r13,$r5
    1260:	5c0008a0 	bne	$r5,$r0,8(0x8) # 1268 <printint.constprop.0+0xf0>
    1264:	002a0007 	break	0x7
    1268:	00df01ef 	bstrpick.d	$r15,$r15,0x1f,0x0
    } while ((x /= base) != 0);
    126c:	002115ae 	div.wu	$r14,$r13,$r5
    1270:	5c0008a0 	bne	$r5,$r0,8(0x8) # 1278 <printint.constprop.0+0x100>
    1274:	002a0007 	break	0x7
        buf[i--] = digits[x % base];
    1278:	38203d8f 	ldx.bu	$r15,$r12,$r15
    127c:	2900486f 	st.b	$r15,$r3,18(0x12)
    } while ((x /= base) != 0);
    1280:	680115a5 	bltu	$r13,$r5,276(0x114) # 1394 <printint.constprop.0+0x21c>
        buf[i--] = digits[x % base];
    1284:	002195cf 	mod.wu	$r15,$r14,$r5
    1288:	5c0008a0 	bne	$r5,$r0,8(0x8) # 1290 <printint.constprop.0+0x118>
    128c:	002a0007 	break	0x7
    1290:	00df01ef 	bstrpick.d	$r15,$r15,0x1f,0x0
    } while ((x /= base) != 0);
    1294:	002115cd 	div.wu	$r13,$r14,$r5
    1298:	5c0008a0 	bne	$r5,$r0,8(0x8) # 12a0 <printint.constprop.0+0x128>
    129c:	002a0007 	break	0x7
        buf[i--] = digits[x % base];
    12a0:	38203d8f 	ldx.bu	$r15,$r12,$r15
    12a4:	2900446f 	st.b	$r15,$r3,17(0x11)
    } while ((x /= base) != 0);
    12a8:	680131c5 	bltu	$r14,$r5,304(0x130) # 13d8 <printint.constprop.0+0x260>
        buf[i--] = digits[x % base];
    12ac:	002195af 	mod.wu	$r15,$r13,$r5
    12b0:	5c0008a0 	bne	$r5,$r0,8(0x8) # 12b8 <printint.constprop.0+0x140>
    12b4:	002a0007 	break	0x7
    12b8:	00df01ef 	bstrpick.d	$r15,$r15,0x1f,0x0
    } while ((x /= base) != 0);
    12bc:	002115ae 	div.wu	$r14,$r13,$r5
    12c0:	5c0008a0 	bne	$r5,$r0,8(0x8) # 12c8 <printint.constprop.0+0x150>
    12c4:	002a0007 	break	0x7
        buf[i--] = digits[x % base];
    12c8:	38203d8f 	ldx.bu	$r15,$r12,$r15
    12cc:	2900406f 	st.b	$r15,$r3,16(0x10)
    } while ((x /= base) != 0);
    12d0:	680115a5 	bltu	$r13,$r5,276(0x114) # 13e4 <printint.constprop.0+0x26c>
        buf[i--] = digits[x % base];
    12d4:	002195cf 	mod.wu	$r15,$r14,$r5
    12d8:	5c0008a0 	bne	$r5,$r0,8(0x8) # 12e0 <printint.constprop.0+0x168>
    12dc:	002a0007 	break	0x7
    12e0:	00df01ef 	bstrpick.d	$r15,$r15,0x1f,0x0
    } while ((x /= base) != 0);
    12e4:	002115cd 	div.wu	$r13,$r14,$r5
    12e8:	5c0008a0 	bne	$r5,$r0,8(0x8) # 12f0 <printint.constprop.0+0x178>
    12ec:	002a0007 	break	0x7
        buf[i--] = digits[x % base];
    12f0:	38203d8f 	ldx.bu	$r15,$r12,$r15
    12f4:	29003c6f 	st.b	$r15,$r3,15(0xf)
    } while ((x /= base) != 0);
    12f8:	6800f9c5 	bltu	$r14,$r5,248(0xf8) # 13f0 <printint.constprop.0+0x278>
        buf[i--] = digits[x % base];
    12fc:	00df01ad 	bstrpick.d	$r13,$r13,0x1f,0x0
    1300:	3820358d 	ldx.bu	$r13,$r12,$r13
    1304:	02801805 	addi.w	$r5,$r0,6(0x6)
    1308:	0280140c 	addi.w	$r12,$r0,5(0x5)
    130c:	2900386d 	st.b	$r13,$r3,14(0xe)

    if (sign)
    1310:	64001880 	bge	$r4,$r0,24(0x18) # 1328 <printint.constprop.0+0x1b0>
        buf[i--] = '-';
    1314:	02c0806d 	addi.d	$r13,$r3,32(0x20)
    1318:	0010b1ad 	add.d	$r13,$r13,$r12
    131c:	0280b40e 	addi.w	$r14,$r0,45(0x2d)
    1320:	293fa1ae 	st.b	$r14,$r13,-24(0xfe8)
    1324:	00150185 	move	$r5,$r12
    write(f, s, l);
    1328:	02c0206c 	addi.d	$r12,$r3,8(0x8)
    132c:	02804006 	addi.w	$r6,$r0,16(0x10)
    1330:	001114c6 	sub.w	$r6,$r6,$r5
    1334:	02800404 	addi.w	$r4,$r0,1(0x1)
    1338:	00109585 	add.d	$r5,$r12,$r5
    133c:	540f3400 	bl	3892(0xf34) # 2270 <write>
    i++;
    if (i < 0)
        puts("printint error");
    out(stdout, buf + i, 16 - i);
}
    1340:	28c0a061 	ld.d	$r1,$r3,40(0x28)
    1344:	02c0c063 	addi.d	$r3,$r3,48(0x30)
    1348:	4c000020 	jirl	$r0,$r1,0
        x = -xx;
    134c:	0011100e 	sub.w	$r14,$r0,$r4
        buf[i--] = digits[x % base];
    1350:	1c00002c 	pcaddu12i	$r12,1(0x1)
    1354:	02cf418c 	addi.d	$r12,$r12,976(0x3d0)
    1358:	002195cf 	mod.wu	$r15,$r14,$r5
    135c:	5c0008a0 	bne	$r5,$r0,8(0x8) # 1364 <printint.constprop.0+0x1ec>
    1360:	002a0007 	break	0x7
    } while ((x /= base) != 0);
    1364:	002115cd 	div.wu	$r13,$r14,$r5
    1368:	5c0008a0 	bne	$r5,$r0,8(0x8) # 1370 <printint.constprop.0+0x1f8>
    136c:	002a0007 	break	0x7
        buf[i--] = digits[x % base];
    1370:	00df01ef 	bstrpick.d	$r15,$r15,0x1f,0x0
    1374:	38203d8f 	ldx.bu	$r15,$r12,$r15
    buf[16] = 0;
    1378:	29006060 	st.b	$r0,$r3,24(0x18)
        buf[i--] = digits[x % base];
    137c:	29005c6f 	st.b	$r15,$r3,23(0x17)
    } while ((x /= base) != 0);
    1380:	6ffe3dc5 	bgeu	$r14,$r5,-452(0x3fe3c) # 11bc <printint.constprop.0+0x44>
        buf[i--] = '-';
    1384:	0280b40c 	addi.w	$r12,$r0,45(0x2d)
    1388:	2900586c 	st.b	$r12,$r3,22(0x16)
        buf[i--] = digits[x % base];
    138c:	02803805 	addi.w	$r5,$r0,14(0xe)
    1390:	53ff9bff 	b	-104(0xfffff98) # 1328 <printint.constprop.0+0x1b0>
    1394:	0280240c 	addi.w	$r12,$r0,9(0x9)
    1398:	02802805 	addi.w	$r5,$r0,10(0xa)
    139c:	53ff77ff 	b	-140(0xfffff74) # 1310 <printint.constprop.0+0x198>
    13a0:	0280340c 	addi.w	$r12,$r0,13(0xd)
    13a4:	02803805 	addi.w	$r5,$r0,14(0xe)
    13a8:	53ff6bff 	b	-152(0xfffff68) # 1310 <printint.constprop.0+0x198>
    13ac:	0280300c 	addi.w	$r12,$r0,12(0xc)
    13b0:	02803405 	addi.w	$r5,$r0,13(0xd)
    13b4:	53ff5fff 	b	-164(0xfffff5c) # 1310 <printint.constprop.0+0x198>
    13b8:	02802c0c 	addi.w	$r12,$r0,11(0xb)
    13bc:	02803005 	addi.w	$r5,$r0,12(0xc)
    13c0:	53ff53ff 	b	-176(0xfffff50) # 1310 <printint.constprop.0+0x198>
    13c4:	0280280c 	addi.w	$r12,$r0,10(0xa)
    13c8:	02802c05 	addi.w	$r5,$r0,11(0xb)
    13cc:	53ff47ff 	b	-188(0xfffff44) # 1310 <printint.constprop.0+0x198>
    i = 15;
    13d0:	02803c05 	addi.w	$r5,$r0,15(0xf)
    13d4:	53ff57ff 	b	-172(0xfffff54) # 1328 <printint.constprop.0+0x1b0>
        buf[i--] = digits[x % base];
    13d8:	0280200c 	addi.w	$r12,$r0,8(0x8)
    13dc:	02802405 	addi.w	$r5,$r0,9(0x9)
    13e0:	53ff33ff 	b	-208(0xfffff30) # 1310 <printint.constprop.0+0x198>
    13e4:	02801c0c 	addi.w	$r12,$r0,7(0x7)
    13e8:	02802005 	addi.w	$r5,$r0,8(0x8)
    13ec:	53ff27ff 	b	-220(0xfffff24) # 1310 <printint.constprop.0+0x198>
    13f0:	0280180c 	addi.w	$r12,$r0,6(0x6)
    13f4:	02801c05 	addi.w	$r5,$r0,7(0x7)
    13f8:	53ff1bff 	b	-232(0xfffff18) # 1310 <printint.constprop.0+0x198>

00000000000013fc <getchar>:
{
    13fc:	02ff8063 	addi.d	$r3,$r3,-32(0xfe0)
    read(stdin, &byte, 1);
    1400:	02c03c65 	addi.d	$r5,$r3,15(0xf)
    1404:	02800406 	addi.w	$r6,$r0,1(0x1)
    1408:	00150004 	move	$r4,$r0
{
    140c:	29c06061 	st.d	$r1,$r3,24(0x18)
    char byte = 0;
    1410:	29003c60 	st.b	$r0,$r3,15(0xf)
    read(stdin, &byte, 1);
    1414:	540e5000 	bl	3664(0xe50) # 2264 <read>
}
    1418:	28c06061 	ld.d	$r1,$r3,24(0x18)
    141c:	28003c64 	ld.b	$r4,$r3,15(0xf)
    1420:	02c08063 	addi.d	$r3,$r3,32(0x20)
    1424:	4c000020 	jirl	$r0,$r1,0

0000000000001428 <putchar>:
{
    1428:	02ff8063 	addi.d	$r3,$r3,-32(0xfe0)
    char byte = c;
    142c:	29003c64 	st.b	$r4,$r3,15(0xf)
    return write(stdout, &byte, 1);
    1430:	02c03c65 	addi.d	$r5,$r3,15(0xf)
    1434:	02800406 	addi.w	$r6,$r0,1(0x1)
    1438:	02800404 	addi.w	$r4,$r0,1(0x1)
{
    143c:	29c06061 	st.d	$r1,$r3,24(0x18)
    return write(stdout, &byte, 1);
    1440:	540e3000 	bl	3632(0xe30) # 2270 <write>
}
    1444:	28c06061 	ld.d	$r1,$r3,24(0x18)
    return write(stdout, &byte, 1);
    1448:	00408084 	slli.w	$r4,$r4,0x0
}
    144c:	02c08063 	addi.d	$r3,$r3,32(0x20)
    1450:	4c000020 	jirl	$r0,$r1,0

0000000000001454 <puts>:
{
    1454:	02ffc063 	addi.d	$r3,$r3,-16(0xff0)
    1458:	29c02061 	st.d	$r1,$r3,8(0x8)
    145c:	27000077 	stptr.d	$r23,$r3,0
    1460:	00150097 	move	$r23,$r4
    r = -(write(stdout, s, strlen(s)) < 0);
    1464:	5406b800 	bl	1720(0x6b8) # 1b1c <strlen>
    1468:	00150086 	move	$r6,$r4
    146c:	001502e5 	move	$r5,$r23
    1470:	02800404 	addi.w	$r4,$r0,1(0x1)
    1474:	540dfc00 	bl	3580(0xdfc) # 2270 <write>
}
    1478:	28c02061 	ld.d	$r1,$r3,8(0x8)
    147c:	26000077 	ldptr.d	$r23,$r3,0
    r = -(write(stdout, s, strlen(s)) < 0);
    1480:	0049fc84 	srai.d	$r4,$r4,0x3f
}
    1484:	02c04063 	addi.d	$r3,$r3,16(0x10)
    1488:	4c000020 	jirl	$r0,$r1,0
...
{
    148c:	02fd4063 	addi.d	$r3,$r3,-176(0xf50)
    1490:	29c1207a 	st.d	$r26,$r3,72(0x48)
    va_list ap;
    int cnt = 0, l = 0;
    ...
    va_start(ap, fmt);
    1494:	02c1e06c 	addi.d	$r12,$r3,120(0x78)
    buf[i++] = '0';
    1498:	140000fa 	lu12i.w	$r26,7(0x7)
{
    149c:	29c14079 	st.d	$r25,$r3,80(0x50)
    14a0:	29c1007b 	st.d	$r27,$r3,64(0x40)
    14a4:	29c0e07c 	st.d	$r28,$r3,56(0x38)
    14a8:	29c1a061 	st.d	$r1,$r3,104(0x68)
    14ac:	29c18077 	st.d	$r23,$r3,96(0x60)
    14b0:	29c16078 	st.d	$r24,$r3,88(0x58)
    14b4:	0015009b 	move	$r27,$r4
    14b8:	29c1e065 	st.d	$r5,$r3,120(0x78)
    14bc:	29c20066 	st.d	$r6,$r3,128(0x80)
    14c0:	29c22067 	st.d	$r7,$r3,136(0x88)
    14c4:	29c24068 	st.d	$r8,$r3,144(0x90)
    14c8:	29c26069 	st.d	$r9,$r3,152(0x98)
    14cc:	29c2806a 	st.d	$r10,$r3,160(0xa0)
    14d0:	29c2a06b 	st.d	$r11,$r3,168(0xa8)
    va_start(ap, fmt);
    14d4:	2700006c 	stptr.d	$r12,$r3,0
    for (;;)
    {
        if (!*s)
            break;
        for (a = s; *s && *s != '%'; s++)
    14d8:	02809419 	addi.w	$r25,$r0,37(0x25)
    buf[i++] = '0';
    14dc:	03a0c35a 	ori	$r26,$r26,0x830
        buf[i++] = digits[x >> (sizeof(uint64) * 8 - 4)];
    14e0:	1c00003c 	pcaddu12i	$r28,1(0x1)
    14e4:	02c9039c 	addi.d	$r28,$r28,576(0x240)
        if (!*s)
    14e8:	2800036c 	ld.b	$r12,$r27,0
    14ec:	40008980 	beqz	$r12,136(0x88) # 1574 <printf+0xe8>
        for (a = s; *s && *s != '%'; s++)
    14f0:	58027d99 	beq	$r12,$r25,636(0x27c) # 176c <printf+0x2e0>
    14f4:	00150366 	move	$r6,$r27
    14f8:	50000800 	b	8(0x8) # 1500 <printf+0x74>
    14fc:	58009d99 	beq	$r12,$r25,156(0x9c) # 1598 <printf+0x10c>
    1500:	02c004c6 	addi.d	$r6,$r6,1(0x1)
    1504:	280000cc 	ld.b	$r12,$r6,0
    1508:	47fff59f 	bnez	$r12,-12(0x7ffff4) # 14fc <printf+0x70>
    150c:	001500d8 	move	$r24,$r6
            ;
        for (z = s; s[0] == '%' && s[1] == '%'; z++, s += 2)
            ;
        l = z - a;
    1510:	0011ecd7 	sub.d	$r23,$r6,$r27
    1514:	004082f7 	slli.w	$r23,$r23,0x0
    write(f, s, l);
    1518:	001502e6 	move	$r6,$r23
    151c:	00150365 	move	$r5,$r27
    1520:	02800404 	addi.w	$r4,$r0,1(0x1)
    1524:	540d4c00 	bl	3404(0xd4c) # 2270 <write>
        out(f, a, l);
        if (l)
    1528:	4400b6e0 	bnez	$r23,180(0xb4) # 15dc <printf+0x150>
            continue;
        if (s[1] == 0)
    152c:	2800070c 	ld.b	$r12,$r24,1(0x1)
    1530:	40004580 	beqz	$r12,68(0x44) # 1574 <printf+0xe8>
            break;
        switch (s[1])
    1534:	0281c00d 	addi.w	$r13,$r0,112(0x70)
    1538:	5800d58d 	beq	$r12,$r13,212(0xd4) # 160c <printf+0x180>
    153c:	6400a9ac 	bge	$r13,$r12,168(0xa8) # 15e4 <printf+0x158>
    1540:	0281cc0d 	addi.w	$r13,$r0,115(0x73)
    1544:	5801f18d 	beq	$r12,$r13,496(0x1f0) # 1734 <printf+0x2a8>
    1548:	0281e00d 	addi.w	$r13,$r0,120(0x78)
    154c:	5c01b18d 	bne	$r12,$r13,432(0x1b0) # 16fc <printf+0x270>
        {
        case 'd':
    ...
    1554:	02804005 	addi.w	$r5,$r0,16(0x10)
    ...
    1568:	57fc13ff 	bl	-1008(0xffffc10) # 1178 <printint.constprop.0>
        if (!*s)
    156c:	2800036c 	ld.b	$r12,$r27,0
    1570:	47ff819f 	bnez	$r12,-128(0x7fff80) # 14f0 <printf+0x64>
    }
    va_end(ap);
}
    1574:	28c1a061 	ld.d	$r1,$r3,104(0x68)
    1578:	28c18077 	ld.d	$r23,$r3,96(0x60)
    157c:	28c16078 	ld.d	$r24,$r3,88(0x58)
    1580:	28c14079 	ld.d	$r25,$r3,80(0x50)
    1584:	28c1207a 	ld.d	$r26,$r3,72(0x48)
    1588:	28c1007b 	ld.d	$r27,$r3,64(0x40)
    158c:	28c0e07c 	ld.d	$r28,$r3,56(0x38)
    1590:	02c2c063 	addi.d	$r3,$r3,176(0xb0)
    1594:	4c000020 	jirl	$r0,$r1,0
        for (z = s; s[0] == '%' && s[1] == '%'; z++, s += 2)
    1598:	280004cc 	ld.b	$r12,$r6,1(0x1)
    159c:	5fff7199 	bne	$r12,$r25,-144(0x3ff70) # 150c <printf+0x80>
    15a0:	001500d8 	move	$r24,$r6
    15a4:	50000c00 	b	12(0xc) # 15b0 <printf+0x124>
    15a8:	2800070c 	ld.b	$r12,$r24,1(0x1)
    15ac:	5fff6599 	bne	$r12,$r25,-156(0x3ff64) # 1510 <printf+0x84>
    15b0:	02c00b18 	addi.d	$r24,$r24,2(0x2)
    15b4:	2800030c 	ld.b	$r12,$r24,0
    15b8:	02c004c6 	addi.d	$r6,$r6,1(0x1)
    15bc:	5bffed99 	beq	$r12,$r25,-20(0x3ffec) # 15a8 <printf+0x11c>
        l = z - a;
    15c0:	0011ecd7 	sub.d	$r23,$r6,$r27
    15c4:	004082f7 	slli.w	$r23,$r23,0x0
    write(f, s, l);
    15c8:	001502e6 	move	$r6,$r23
    15cc:	00150365 	move	$r5,$r27
    15d0:	02800404 	addi.w	$r4,$r0,1(0x1)
    15d4:	540c9c00 	bl	3228(0xc9c) # 2270 <write>
        if (l)
    15d8:	43ff56ff 	beqz	$r23,-172(0x7fff54) # 152c <printf+0xa0>
    15dc:	0015031b 	move	$r27,$r24
    15e0:	53ff0bff 	b	-248(0xfffff08) # 14e8 <printf+0x5c>
        switch (s[1])
    15e4:	0281900d 	addi.w	$r13,$r0,100(0x64)
    15e8:	5c01158d 	bne	$r12,$r13,276(0x114) # 16fc <printf+0x270>
            printint(va_arg(ap, int), 10, 1);
    15ec:	2600006c 	ldptr.d	$r12,$r3,0
    15f0:	02802805 	addi.w	$r5,$r0,10(0xa)
        s += 2;
    15f4:	02c00b1b 	addi.d	$r27,$r24,2(0x2)
            printint(va_arg(ap, int), 10, 1);
    15f8:	24000184 	ldptr.w	$r4,$r12,0
    15fc:	02c0218c 	addi.d	$r12,$r12,8(0x8)
    1600:	2700006c 	stptr.d	$r12,$r3,0
    1604:	57fb77ff 	bl	-1164(0xffffb74) # 1178 <printint.constprop.0>
        s += 2;
    1608:	53ff67ff 	b	-156(0xfffff64) # 156c <printf+0xe0>
            printptr(va_arg(ap, uint64));
    160c:	2600006d 	ldptr.d	$r13,$r3,0
    buf[i++] = '0';
    1610:	2940207a 	st.h	$r26,$r3,8(0x8)
    write(f, s, l);
    1614:	02804806 	addi.w	$r6,$r0,18(0x12)
            printptr(va_arg(ap, uint64));
    1618:	260001ac 	ldptr.d	$r12,$r13,0
    161c:	02c021ad 	addi.d	$r13,$r13,8(0x8)
    1620:	2700006d 	stptr.d	$r13,$r3,0
        buf[i++] = digits[x >> (sizeof(uint64) * 8 - 4)];
    1624:	0045f18a 	srli.d	$r10,$r12,0x3c
    1628:	00fbe189 	bstrpick.d	$r9,$r12,0x3b,0x38
    162c:	00f7d188 	bstrpick.d	$r8,$r12,0x37,0x34
    1630:	00f3c187 	bstrpick.d	$r7,$r12,0x33,0x30
    1634:	00efb185 	bstrpick.d	$r5,$r12,0x2f,0x2c
    1638:	00eba184 	bstrpick.d	$r4,$r12,0x2b,0x28
    163c:	00e79194 	bstrpick.d	$r20,$r12,0x27,0x24
    1640:	00e38193 	bstrpick.d	$r19,$r12,0x23,0x20
    1644:	00df7192 	bstrpick.d	$r18,$r12,0x1f,0x1c
    1648:	00db6191 	bstrpick.d	$r17,$r12,0x1b,0x18
    164c:	00d75190 	bstrpick.d	$r16,$r12,0x17,0x14
    1650:	00d3418f 	bstrpick.d	$r15,$r12,0x13,0x10
    1654:	00cf318e 	bstrpick.d	$r14,$r12,0xf,0xc
    1658:	00cb218d 	bstrpick.d	$r13,$r12,0xb,0x8
    165c:	38202b8b 	ldx.bu	$r11,$r28,$r10
    1660:	3820278a 	ldx.bu	$r10,$r28,$r9
    1664:	38202389 	ldx.bu	$r9,$r28,$r8
    1668:	38201f88 	ldx.bu	$r8,$r28,$r7
    166c:	38201787 	ldx.bu	$r7,$r28,$r5
    1670:	38201385 	ldx.bu	$r5,$r28,$r4
    1674:	38205384 	ldx.bu	$r4,$r28,$r20
    1678:	38204f94 	ldx.bu	$r20,$r28,$r19
    167c:	38204b93 	ldx.bu	$r19,$r28,$r18
    1680:	38204792 	ldx.bu	$r18,$r28,$r17
    1684:	38204391 	ldx.bu	$r17,$r28,$r16
    1688:	38203f90 	ldx.bu	$r16,$r28,$r15
    168c:	38203b8f 	ldx.bu	$r15,$r28,$r14
    1690:	3820378e 	ldx.bu	$r14,$r28,$r13
    1694:	00c7118d 	bstrpick.d	$r13,$r12,0x7,0x4
    1698:	03403d8c 	andi	$r12,$r12,0xf
    169c:	2900286b 	st.b	$r11,$r3,10(0xa)
    16a0:	29002c6a 	st.b	$r10,$r3,11(0xb)
    16a4:	29003069 	st.b	$r9,$r3,12(0xc)
    16a8:	29003468 	st.b	$r8,$r3,13(0xd)
    16ac:	29003867 	st.b	$r7,$r3,14(0xe)
    16b0:	29003c65 	st.b	$r5,$r3,15(0xf)
    16b4:	29004064 	st.b	$r4,$r3,16(0x10)
    16b8:	29004474 	st.b	$r20,$r3,17(0x11)
    16bc:	29004873 	st.b	$r19,$r3,18(0x12)
    16c0:	29004c72 	st.b	$r18,$r3,19(0x13)
    16c4:	29005071 	st.b	$r17,$r3,20(0x14)
    16c8:	29005470 	st.b	$r16,$r3,21(0x15)
    16cc:	2900586f 	st.b	$r15,$r3,22(0x16)
    16d0:	29005c6e 	st.b	$r14,$r3,23(0x17)
    16d4:	3820378d 	ldx.bu	$r13,$r28,$r13
    16d8:	3820338c 	ldx.bu	$r12,$r28,$r12
    write(f, s, l);
    16dc:	02c02065 	addi.d	$r5,$r3,8(0x8)
    16e0:	02800404 	addi.w	$r4,$r0,1(0x1)
        buf[i++] = digits[x >> (sizeof(uint64) * 8 - 4)];
    16e4:	2900606d 	st.b	$r13,$r3,24(0x18)
    16e8:	2900646c 	st.b	$r12,$r3,25(0x19)
    buf[i] = 0;
    16ec:	29006860 	st.b	$r0,$r3,26(0x1a)
        s += 2;
    16f0:	02c00b1b 	addi.d	$r27,$r24,2(0x2)
    write(f, s, l);
    16f4:	540b7c00 	bl	2940(0xb7c) # 2270 <write>
        s += 2;
    16f8:	53fe77ff 	b	-396(0xffffe74) # 156c <printf+0xe0>
    char byte = c;
    16fc:	0280940c 	addi.w	$r12,$r0,37(0x25)
    return write(stdout, &byte, 1);
    1700:	02800406 	addi.w	$r6,$r0,1(0x1)
    1704:	02c02065 	addi.d	$r5,$r3,8(0x8)
    1708:	02800404 	addi.w	$r4,$r0,1(0x1)
    char byte = c;
    170c:	2900206c 	st.b	$r12,$r3,8(0x8)
    return write(stdout, &byte, 1);
    1710:	540b6000 	bl	2912(0xb60) # 2270 <write>
    char byte = c;
    1714:	2a00070c 	ld.bu	$r12,$r24,1(0x1)
    return write(stdout, &byte, 1);
    ...
    return write(stdout, &byte, 1);
    172c:	540b4400 	bl	2884(0xb44) # 2270 <write>
        s += 2;
    1730:	53fe3fff 	b	-452(0xffffe3c) # 156c <printf+0xe0>
            if ((a = va_arg(ap, char *)) == 0)
    1734:	2600006c 	ldptr.d	$r12,$r3,0
    1738:	26000197 	ldptr.d	$r23,$r12,0
    173c:	02c0218c 	addi.d	$r12,$r12,8(0x8)
    1740:	2700006c 	stptr.d	$r12,$r3,0
    1744:	40004ee0 	beqz	$r23,76(0x4c) # 1790 <printf+0x304>
            l = strnlen(a, 200);
    1748:	02832005 	addi.w	$r5,$r0,200(0xc8)
    174c:	001502e4 	move	$r4,$r23
    1750:	5405b400 	bl	1460(0x5b4) # 1d04 <strnlen>
    1754:	00408086 	slli.w	$r6,$r4,0x0
    write(f, s, l);
    1758:	001502e5 	move	$r5,$r23
    175c:	02800404 	addi.w	$r4,$r0,1(0x1)
    1760:	540b1000 	bl	2832(0xb10) # 2270 <write>
        s += 2;
    1764:	02c00b1b 	addi.d	$r27,$r24,2(0x2)
    1768:	53fe07ff 	b	-508(0xffffe04) # 156c <printf+0xe0>
        for (z = s; s[0] == '%' && s[1] == '%'; z++, s += 2)
    176c:	2800076c 	ld.b	$r12,$r27,1(0x1)
    1770:	00150366 	move	$r6,$r27
    1774:	5bfe2d99 	beq	$r12,$r25,-468(0x3fe2c) # 15a0 <printf+0x114>
    write(f, s, l);
    1778:	00150006 	move	$r6,$r0
    177c:	00150365 	move	$r5,$r27
    1780:	02800404 	addi.w	$r4,$r0,1(0x1)
    1784:	540aec00 	bl	2796(0xaec) # 2270 <write>
    1788:	00150378 	move	$r24,$r27
    178c:	53fda3ff 	b	-608(0xffffda0) # 152c <printf+0xa0>
                a = "(null)";
    1790:	1c000037 	pcaddu12i	$r23,1(0x1)
    1794:	02fbe2f7 	addi.d	$r23,$r23,-264(0xef8)
    1798:	53ffb3ff 	b	-80(0xfffffb0) # 1748 <printf+0x2bc>
